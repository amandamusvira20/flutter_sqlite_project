...
import 'package:flutter_sqlite_project/helper/dbhelper.dart';
import 'package:flutter_sqlite_project/models/contact.dart';
import 'package:flutter_sqlite_project/pages/contactForm.dart';
...
//membuat dialog konfirmasi hapus
                          AlertDialog hapus = AlertDialog(
                            ...
                            content: Container(
                              ...
                              child: Column(
                                children: [
                                  Text("Are you sure delete? ${kontak.name}")
                                ],
                              ),
                            ),
//terdapat 2 button.
